...
print(color("|                                       |",(CYAN)))
print(color("|",(CYAN))+color("  welcome ",(ORANGE))+color("|",(CYAN)))
print(color("|",(CYAN))+color("  HAMZA_SCAN ",(ORANGE))+color("|",(CYAN)))
...
print(color("|                                |",(CYAN)))
print(color("|",(CYAN))+color("  1):",(WHITE))+color(" Scan-port                       ",(ORANGE))+color("|",(CYAN)))
print(color("|",(CYAN))+color("  2):",(WHITE))+color(" Brut-Forcing-Directory                 ",(ORANGE))+color("|",(CYAN)))
print(color("|",(CYAN))+color("  3):",(WHITE))+color(" All   ",(ORANGE))+color("|",(CYAN)))
